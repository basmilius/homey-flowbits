...
export const REALTIME_LABELS_UPDATE = 'flowbits-labels-update';
export const REALTIME_MODE_UPDATE = 'flowbits-mode-update';
export const REALTIME_MODE_SET_UPDATE = 'flowbits-mode-set-update';
export const REALTIME_SETS_UPDATE = 'flowbits-sets-update';
...
export const SETTING_FLAGS = 'flowbits-flags';
export const SETTING_FLAG_LOOKS = 'flowbits-flag-looks';
export const SETTING_FLAG_LAST_UPDATES = 'flowbits-flag-last-updates';
export const SETTING_LABELS = 'flowbits-labels';
export const SETTING_LABEL_LOOKS = 'flowbits-label-looks';
export const SETTING_MODE = 'flowbits-mode';
export const SETTING_MODE_LOOKS = 'flowbits-mode-looks';
export const SETTING_MODE_LAST_UPDATES = 'flowbits-mode-last-updates';
export const SETTING_MODE_SET_CURRENT = 'flowbits-mode-set-current';
export const SETTING_MODE_SET_LAST_UPDATES = 'flowbits-mode-set-last-updates';
export const SETTING_MODE_SET_LOOKS = 'flowbits-mode-set-looks';
...
export const TOKEN_MODE_SET_CURRENT_MODE_PREFIX = 'mode_set_current_mode_';
